...
```
## Table of contents
1. [More Customers Prefer Elago](#BrandPartner)
2. [Results of the c5.0 Model](#Prediction)
3. [Comparing Accuracy of the Two Predictive Models](#Accuracy)
        1. [Random Forest Classifier](#RFmodel)  
        2. [C5.0 Classifier](#C50model) 
...
*3. Some other considerations might include*
      * Is Blackwell targetting a specific customer segment to boost sales?
        ...
        * Customers who were 55 years and younger prefer Elago products.
            * Median age of customers who prefered Elago was around 40 years.
            * Median age for customers who said they prefered Belkin was around 60  years.
